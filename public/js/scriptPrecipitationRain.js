...
function init() {
    ...
    const sneg = document.getElementById("sneg")
    const minS = document.getElementById("min-sneg")
    const maxS = document.getElementById("max-sneg")
    ...
    sneg.addEventListener("change", toggleSubset)
    minS.addEventListener("change", toggleMainField)
    maxS.addEventListener("change", toggleMainField)
}
...
function submitForm(ev) {
    ...
    const urlQS = "/getPrecipitationRain?" + queryString
